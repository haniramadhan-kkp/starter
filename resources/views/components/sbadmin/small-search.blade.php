...
<li class="nav-item dropdown no-caret d-lg-none me-3">
    ...
    <!-- Dropdown - Search-->
    <div class="dropdown-menu dropdown-menu-end animated--fade-in-up p-3 shadow" aria-labelledby="searchDropdown">
        <form class="form-inline w-100 me-auto">
