    ...
    <main>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-10">
                        <div class="section-title wow fadeInDown animated mb-80 pl-40 pr-40 text-center"
        ...
        <section class="choose-area pt-120 pb-120 p-relative" style="background: #f5f8fa">
            <div class="chosse-img wow fadeInRight animated" data-animation="fadeInRight animated" data-delay=".2s"
                style="background-image: url(img/bg/about.jpg)"></div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-6">
                            ...
                            <div class="choose-content wow fadeInUp animated" data-animation="fadeInDown animated"
                                ...
                                <div class="choose-list mb-45">
                                    <ul>
                                        ...
                                        <li>
                                            <i class="icon dripicons-checkmark"></i>
                                            <span>amet, ante. Donec eu libero
        ...
        <section id="services" class="services-area services-bg services-two pt-120 pb-90">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp animated" data-animation="fadeInDown animated"
                        data-delay=".2s">
        ...
        <!-- services-area-end -->
        <!-- brand-area -->
        <div class="brand-area pt-120 pb-120" style="background-color: #425cbb">
            <div class="container">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-8">
                        <div class="section-title wow fadeInDown animated mb-80 text-center"
                            data-animation="fadeInDown animated" data-delay=".2s">
                            <span>Best Work</span>
                ...
                <div class="portfolio wow fadeInUp animated" data-animation="fadeInDown animated" data-delay=".2s">
                    ...
                    <div class="col3 grid">
                        ...
                        <div class="grid-item applications development">
                            <a class="gallery-link popup-image" href="img/gallery/protfolio-img02.jpg">
                                <figure class="gallery-image">
                                    <img src="img/gallery/protfolio-img02.jpg" alt="protfolio-img01" />
                                    <figcaption>Development 01</figcaption>
                                </figure>
                            </a>
                        </div>
                        <div class="grid-item web-design">
                            <a class="gallery-link popup-image" href="img/gallery/protfolio-img03.jpg">
                                <figure class="gallery-image">
                                    <img src="img/gallery/protfolio-img03.jpg" alt="protfolio-img01" />
                                    <figcaption>Web Design 01</figcaption>
                                </figure>
                            </a>
                        </div>
                        <div class="grid-item logo">
                            <a class="gallery-link popup-image" href="img/gallery/protfolio-img04.jpg">
                                <figure class="gallery-image">
                                    <img src="img/gallery/protfolio-img04.jpg" alt="protfolio-img01" />
                                    <figcaption>Applications</figcaption>
                                </figure>
                            </a>
                        </div>
                        <div class="grid-item development">
                            <a class="gallery-link popup-image" href="img/gallery/protfolio-img05.jpg">
                                <figure class="gallery-image">
                                    <img src="img/gallery/protfolio-img05.jpg" alt="protfolio-img01" />
                                    <figcaption>Development</figcaption>
                                </figure>
                            </a>
                        </div>
                        <div class="grid-item logo web-design">
                            <a class="gallery-link popup-image" href="img/gallery/protfolio-img06.jpg">
                                <figure class="gallery-image">
                                    <img src="img/gallery/protfolio-img06.jpg" alt="protfolio-img01" />
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-counter mb-30 wow fadeInUp animated text-center"
                            data-animation="fadeInDown animated" data-delay=".2s">
        ...
        <section id="pricing" class="pricing-area pt-113 pb-90">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="pricing-box wow fadeInUp animated mb-60 text-center"
                            data-animation="fadeInDown animated" data-delay=".2s">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="pricing-box active wow fadeInUp animated mb-60 text-center"
                            data-animation="fadeInDown animated" data-delay=".2s">
                            <div class="pricing-head">
                                <h4>Standard Plan</h4>
                                <div class="price-count mb-30">
        ...
        <!-- pricing-area-end -->
        <!-- team-area -->
        <section id="team" class="team-area pt-120 pb-90" style="background: #f5f5f5">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-8">
                        <div class="section-title wow fadeInDown animated mb-80 text-center"
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="single-team mb-30 wow fadeInUp animated text-center"
                            data-animation="fadeInDown animated" data-delay=".2s">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-team mb-30 wow fadeInUp animated text-center"
                            data-animation="fadeInDown animated" data-delay=".2s">
                            <div class="team-thumb">
                                <img src="img/team/team-img02.jpg" alt="img" />
                            </div>
                            <div class="team-info">
                                <h4>Alina Roboto</h4>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-team mb-30 wow fadeInUp animated text-center"
                            data-animation="fadeInDown animated" data-delay=".2s">
                            <div class="team-thumb">
                                <img src="img/team/team-img03.jpg" alt="img" />
                            </div>
                            <div class="team-info">
                                <h4>Rock Alane</h4>
        ...
        <section id="testimonios" class="testimonial-area gray-bg testimonial-p pt-115 pb-185 text-center"
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="section-title center-align wow fadeInDown animated mb-40"
                            data-animation="fadeInDown animated" data-delay=".2s">
        ...
        <section id="blog" class="blog-area p-relative pt-120 pb-90">
            <div class="container">
                ...
                <div class="row">
                            ...
                            <div class="blog-content">
                                <div class="b-meta mb-20">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="#" class="corpo">Corporate</a>
                                        </li>
                                    </ul>
                                </div>
                                <h4>
                                    <a href="blog-details.html">Making Distribut Product Team Work
                                        More With Monday</a>
                                </h4>
                                <p>
                                    Lorem ipsum dolor sit amet consectetur
                                    adipisi cing elit sed do eiusmod tempor
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-post active mb-30 wow fadeInUp animated"
                            data-animation="fadeInDown animated" data-delay=".2s">
                            <div class="blog-thumb">
                            ...
                            <div class="blog-content">
                                ...
                                <h4>
                                    <a href="blog-details.html">Monthly Web Development Upto Cost
                                        Of JavaScript Ethics</a>
                                </h4>
                                <p>
                                    Lorem ipsum dolor sit amet consectetur
                                    adipisi cing elit sed do eiusmod tempor
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-post mb-30 wow fadeInUp animated" data-animation="fadeInDown animated"
                            ...
                            <div class="blog-content">
                                ...
                                <h4>
                                    <a href="blog-details.html">User Experience Psychology And
                                        Performance Smashing</a>
                                </h4>
                                <p>
                                    Lorem ipsum dolor sit amet consectetur
                                    adipisi cing elit sed do eiusmod tempor
                ...
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <div class="single-cta pb-30 mb-30 wow fadeInUp animated" data-animation="fadeInDown animated"
                            ...
                            <h5>Message Us</h5>
                            <p>
                                We are always with you to solve your problem
                                mail us : <a href="#">support@gmail.com</a>
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-8">
                    ...
                    <div class="col-xl-3 col-lg-3 col-sm-6">
                        <div class="footer-widget mb-30">
                            ...
                            <div class="footer-text mb-20">
                                <p>
                                    Sed ut perspiciatis unde om is nerror
                                    sit voluptatem accustium dolorem tium
                                    totam rem aperam eaque ipsa quae ab
                    ...
                    <div class="col-xl-3 col-lg-3 col-sm-6">
                        <div class="footer-widget mb-30">
                            ...
                            <div class="f-insta">
                                <ul>
                                    <li>
                                        <a href="#"><img src="img/instagram/insta_post01.jpg"
                                                alt="img" /></a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="img/instagram/insta_post02.jpg"
                                                alt="img" /></a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="img/instagram/insta_post03.jpg"
                                                alt="img" /></a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="img/instagram/insta_post04.jpg"
                                                alt="img" /></a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="img/instagram/insta_post05.jpg"
                                                alt="img" /></a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="img/instagram/insta_post06.jpg"
                                                alt="img" /></a>
                                    </li>
                                </ul>
                            </div>
