...
<html lang="en">
    ...
    <body class="nav-fixed">
        <nav
            class="topnav navbar navbar-expand justify-content-between justify-content-sm-start navbar-light bg-white shadow"
            id="sidenavAccordion"
        >
            <!-- Sidenav Toggle Button-->
            <button
                class="btn btn-icon btn-transparent-dark order-lg-0 ms-lg-2 me-lg-0 order-1 me-2"
                id="sidebarToggle"
            >
            ...
            <a class="navbar-brand ps-lg-2 pe-3 ps-4" href="{{ Route('home') }}"
                >Ispikani</a
            >
            <!-- Navbar Search Input-->
            ...
            <ul class="navbar-nav align-items-center ms-auto">
                ...
                <x-partials.sbadmin.message>
                    <x-sbadmin.single-message>
                        ...
                        <x-slot:profile
                            >sbadmin/assets/img/illustrations/profiles/profile-2.png</x-slot:profile
                        >
                        <x-slot:message
                ...
                <x-partials.sbadmin.user>
                    <x-slot:profile
                        >sbadmin/assets/img/illustrations/profiles/profile-1.png</x-slot:profile
                    >
                            ...
                            >
                                ...
                                >
                                    <a
                                        ...
                                        href="{{
                                            Route(
                                                'dashboard.user.registrations.index'
                                            )
                                        }}"
                                    >
                                        Profile
